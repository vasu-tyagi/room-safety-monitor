...
| GPU-accelerated inference serving | **Substituted** | Models run in-process on CPU. Production would use GPU inference serving to meet sub-50ms per-frame latency. |
